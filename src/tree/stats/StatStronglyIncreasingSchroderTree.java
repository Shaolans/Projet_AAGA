...
public class StatStronglyIncreasingSchroderTree {
	public static void main(String[] args) {
		...
		StronglyIncreasingSchroderTree sist = new StronglyIncreasingSchroderTree(5000);
		...
		printData("stats/statStrongAvgNodesTreeBuilder.txt", statAvgNodesTreeBuilder.toString());
		printData("stats/statStrongAvgNodesUnrank.txt", statAvgNodesUnrank.toString());
		printData("stats/statStrongAvgHeightTreeBuilder.txt", statAvgHeightTreeBuilder.toString());
		printData("stats/statStrongAvgHeightUnrank.txt", statAvgHeightUnrank.toString());
